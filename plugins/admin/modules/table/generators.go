...
import (
	...
	"github.com/eavesmy/goadmin/modules/collection"
	"github.com/eavesmy/goadmin/modules/config"
	"github.com/eavesmy/goadmin/modules/db"
	"github.com/eavesmy/goadmin/modules/db/dialect"
	errs "github.com/eavesmy/goadmin/modules/errors"
	"github.com/eavesmy/goadmin/modules/language"
	"github.com/eavesmy/goadmin/modules/logger"
	"github.com/eavesmy/goadmin/modules/ui"
	"github.com/eavesmy/goadmin/modules/utils"
	"github.com/eavesmy/goadmin/plugins/admin/models"
	form2 "github.com/eavesmy/goadmin/plugins/admin/modules/form"
	"github.com/eavesmy/goadmin/plugins/admin/modules/parameter"
	"github.com/eavesmy/goadmin/plugins/admin/modules/tools"
	"github.com/eavesmy/goadmin/template"
	"github.com/eavesmy/goadmin/template/types"
	"github.com/eavesmy/goadmin/template/types/action"
	"github.com/eavesmy/goadmin/template/types/form"
	selection "github.com/eavesmy/goadmin/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/eavesmy/goadmin/modules/db/dialect", Value: "github.com/eavesmy/goadmin/modules/db/dialect"},
			{Text: "github.com/eavesmy/goadmin/modules/db", Value: "github.com/eavesmy/goadmin/modules/db"},
			{Text: "github.com/eavesmy/goadmin/modules/language", Value: "github.com/eavesmy/goadmin/modules/language"},
			{Text: "github.com/eavesmy/goadmin/modules/logger", Value: "github.com/eavesmy/goadmin/modules/logger"},
		}).
		FieldDefault("").
