...
import (
	...
	errors2 "github.com/eavesmy/goadmin/modules/errors"
	...
	"github.com/eavesmy/goadmin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/eavesmy/goadmin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/eavesmy/goadmin/blob/master/template/login/list.go
	GetAssetList() []string
