...
> make serve</pre>
                            ...
                            <ul>
                                <li>
                                    <span style="font-size:15px;font-weight:normal;">Github：&nbsp;<a
                                                href="https://github.com/eavesmy/goadmin" target="_blank">https://github.com/eavesmy/goadmin</a></span>
                                </li>
                                <li>
                    ...
                    <div class="ui attached segment install-success-readme-en"
                        ...
                        <ul>
                            <li>
                                <a href="https://raw.githubusercontent.com/eavesmy/goadmin/master/data/admin.sql"
                                   target="_blank">Mysql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/eavesmy/goadmin/master/data/admin.mssql"
                                   target="_blank">Mssql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/eavesmy/goadmin/master/data/admin.pgsql"
                                   target="_blank">Postgresql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/eavesmy/goadmin/master/data/admin.db"
