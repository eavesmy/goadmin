...
import (
	...
	_ "github.com/eavesmy/goadmin/adapter/gin"                    // web framework adapter
	_ "github.com/eavesmy/goadmin/modules/db/drivers/{{.DriverModule}}" // sql driver
...
import (
	...
	_ "github.com/eavesmy/goadmin/adapter/beego"                   // web framework adapter
	_ "github.com/eavesmy/goadmin/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/GoAdminGroup/themes/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/eavesmy/goadmin/adapter/buffalo"                 // web framework adapter
	_ "github.com/eavesmy/goadmin/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/GoAdminGroup/themes/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/eavesmy/goadmin/adapter/chi"                 // web framework adapter
	_ "github.com/eavesmy/goadmin/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/GoAdminGroup/themes/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/eavesmy/goadmin/adapter/echo"                 // web framework adapter
	_ "github.com/eavesmy/goadmin/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/GoAdminGroup/themes/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/eavesmy/goadmin/adapter/fasthttp"                 // web framework adapter
	_ "github.com/eavesmy/goadmin/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/GoAdminGroup/themes/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/eavesmy/goadmin/adapter/gf"                 // web framework adapter
	_ "github.com/eavesmy/goadmin/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/GoAdminGroup/themes/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/eavesmy/goadmin/adapter/gorilla"                 // web framework adapter
	_ "github.com/eavesmy/goadmin/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/GoAdminGroup/themes/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/eavesmy/goadmin/adapter/iris"                 // web framework adapter
	_ "github.com/eavesmy/goadmin/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/GoAdminGroup/themes/{{.Theme}}"                        // ui theme
...
import (
	...
	template2 "github.com/eavesmy/goadmin/template"
	"github.com/eavesmy/goadmin/template/chartjs"
...
import (
	"github.com/eavesmy/goadmin/context"
	tmpl "github.com/eavesmy/goadmin/template"
	"github.com/eavesmy/goadmin/template/chartjs"
	"github.com/eavesmy/goadmin/template/icon"
	"github.com/eavesmy/goadmin/template/types"
...
- [github](https://github.com/eavesmy/goadmin)
