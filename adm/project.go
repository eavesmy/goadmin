...
func buildProject(cfgFile string) {
	...
	if defaultLang == "cn" || p.Language == language.CN || p.Language == "cn" {
		...
		fmt.Println("- sqlite: " + ansi.Color("https://github.com/eavesmy/goadmin/raw/master/data/admin.db", "blue"))
		fmt.Println("- mssql: " + ansi.Color("https://raw.githubusercontent.com/eavesmy/goadmin/master/data/admin.mssql", "blue"))
		fmt.Println("- postgresql: " + ansi.Color("https://raw.githubusercontent.com/eavesmy/goadmin/master/data/admin.pgsql", "blue"))
		fmt.Println("- mysql: " + ansi.Color("https://raw.githubusercontent.com/eavesmy/goadmin/master/data/admin.sql", "blue"))
	}
	fmt.Println()
...
import "github.com/eavesmy/goadmin/plugins/admin/modules/table"
